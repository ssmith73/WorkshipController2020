...
//To load USB ->sudo chmod a+rw /dev/ttyUSB0
...
int i2c_ambTempTh = 10;
int i2c_pipeTempTh = 50;
...
void setup() /****** SETUP: RUNS ONCE ******/
{
  ...
  digitalWrite(PUMP_RELAY_EN, (HIGH & i2c_turnOnFan) | i2c_turnOffFan);
...
void loop()   /****** LOOP: RUNS CONSTANTLY ******/
{
  ...
  else if (myRadio.available()) // Check for incoming data from transmitters
  {
    ...
    if (averagedAmbTemp > i2c_ambTempTh + 1) {
    ...
    else if (averagedAmbTemp > i2c_ambTempTh) {
      ...
      if (pipeTemperature < i2c_pipeTempTh) {
        ...
        //digitalWrite(PUMP_RELAY_EN, (LOW & i2c_turnOnFan) | i2c_turnOffFan);
        //delay(100);
